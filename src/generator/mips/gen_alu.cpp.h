...
extern INLINE u32 gen(SRL, u32 rd, u32 rt, u32 sa) { ARM_EMIT(ARM_POINTER, 0x00000002 | (rt << 16) | (rd << 11) | ((sa & 31) << 6)); return 1; }
...
extern INLINE u32 gen(ANDI, u32 rt, u32 rs, u32 imm16)
{
  ...
  case 2:
	...
	return n;
#else
  ARM_EMIT(ARM_POINTER, 0x30000000 | (rs << 21) | (rt << 16) | (imm16 & 0xffff));
  return 1;
#endif
}
