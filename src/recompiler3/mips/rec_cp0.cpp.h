...
static void recRFE()
{
	...
	ARM_EMIT(ARM_POINTER, 0x3400fff0 | (TEMP_2 << 21) | (TEMP_2 << 16)); /* ori 0xfff0 */
	...
	ARM_EMIT(ARM_POINTER, 0x30000000 | (TEMP_1 << 21) | (TEMP_1 << 16) | 0x3c); /* andi t1, t1, 0x3c */
	//ARM_ORR_REG_IMMSHIFT(ARM_POINTER, TEMP_1, TEMP_2, TEMP_1, ARMSHIFT_LSR, 2);
	ARM_EMIT(ARM_POINTER, 0x00000002 | (TEMP_1 << 16) | (TEMP_1 << 11) | (2 << 6)); /* srl t1, t1, 2 */
	ARM_EMIT(ARM_POINTER, 0x00000025 | (TEMP_2 << 21) | (TEMP_1 << 16) | (TEMP_1 << 11)); /* or t1, t2, t1 */
